...
public class Operadores {
	 ...
	 * multiplicacioon: * 
	 * divisioon: / ----------->
	 * Para que te de resultados decimales tienes que operar con al menos una de las
	 * variables o nuumeros en formato decimal. Si metes ambos int te daraa
	 * resultado numero.0: no te saca el decimal.
	 * 
	 * Loogicos/relacionales
	 * 
	 * mayor que: >
	 * menor que: <
	 * mayor o menor que:<>
	 ...
	 *  distinto: != 
	 *  igual que: ==
	 *  igual en string: .equals()
	 * 
	 * Incremento y decremento (si se pone antes o despuees es importante)
	 * 
	 * incremento: ++ (incrementa en 1 al valor al que se le aplica)
	 * decremento: --
	 * incremento alternativo: += nº 
	 * decremento alternativo: -= nº
	 * 
	 * Concatenaciones
	 * 
