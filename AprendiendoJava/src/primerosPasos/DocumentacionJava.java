...
public class DocumentacionJava {
	...
	public static void main(String[] args) {
		...
		// Autotabulacioon = Ctrl + �; Lo cambie desde el original: Ctrl + Shift + F.
		 ...
		 * incremento alternativo: += n� decremento alternativo: -=
		 * 
		 * Concatenaciones
		 * 
		 ...
		 * la interfaz al S.O. hu�sped. Dado que eso haciia que en cada S.O. se portase
